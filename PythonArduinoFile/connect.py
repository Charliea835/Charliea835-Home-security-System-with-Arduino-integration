...
from time import sleep						#import all libraries needed.
import serial
import sys
...
cursor.execute("DROP TABLE IF EXISTS Alarm;") #drop the alarm table at the beggining as to emulate that every users data is different for getting their alarm data
